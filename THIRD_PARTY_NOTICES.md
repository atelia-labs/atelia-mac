...
This repository bundles the following third-party font software in
`Sources/AteliaMacClient/Resources/Fonts`. Each font is licensed under the SIL
Open Font License, Version 1.1.

## Inter

- Files: `Inter-Light.ttf`, `Inter-Regular.ttf`, `Inter-Medium.ttf`,
  `Inter-SemiBold.ttf`
...
Copyright (c) 2005-2017, SIL International (http://www.sil.org/)
